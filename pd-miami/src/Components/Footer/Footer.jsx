          ...
          <div className="content__footer">
            <div className="profile">
              <div className="logo__area">
                <img src={Logo} alt="" />
                <span className="logo__name">Project Downtown</span>
              </div>
              <div className="desc__area">
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Architecto, autem ad aliquid fugiat tenetur totam!
                </p>
              </div>
        ...
        <footer className={classes.footer}>
          <div className={classes.footer__newsletter}>
            <h4 className={classes.footer__newsletter__headline}>
              Join the Tropic newsletter to receive groundbreaking travel
              rewards
            </h4>
